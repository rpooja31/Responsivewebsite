...
const FeatureSectionFruits = (props) => {
    return (
        <div className="container pt-16">
            <div className="lg:flex justify-between items-center">
                <div>
                    <h3 className="font-medium text-2xl">Fruits & Vagitable</h3>
                    <p className="text-gray-600 mt-2">buy farm fresh and vegitables online at the best prices</p>
                </div>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 mt-8 gap-2">
                {/* <div>
                    <img className='' src='images/feature__2.webp' alt='banner' />
                </div> */}
                {data.map((el) => (
